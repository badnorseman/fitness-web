...
class Signup extends Component {
  ...
  constructor(props) {
    ...
    this.months.push({value:1, name:"January"});
    this.months.push({value:2, name:"February"});
    this.months.push({value:3, name:"March"});
    this.months.push({value:4, name:"April"});
    this.months.push({value:5, name:"May"});
    this.months.push({value:6, name:"June"});
    this.months.push({value:7, name:"July"});
    this.months.push({value:8, name:"August"});
    this.months.push({value:9, name:"September"});
    this.months.push({value:10, name:"October"});
    this.months.push({value:11, name:"November"});
    this.months.push({value:12, name:"December"});
            ...
            <div className="mdl-card--border mdl-cell mdl-cell--12-col">
              <form onSubmit={this._handleSubmit}>
                ...
                <div className="mdl-cell mdl-cell--12-col birthday__datepicker">
                  <Select className="birthday__select" onChange={this._yearChanged} options={this.years} id="birthday-year" name="Year" />
                  <Select className="birthday__select birthday__select--side-margin" onChange={this._monthChanged} options={this.months} id="birthday-month" name="Month" />
